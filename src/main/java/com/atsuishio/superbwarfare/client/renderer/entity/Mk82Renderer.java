...
public class Mk82Renderer extends GeoEntityRenderer<Mk82Entity> {
    ...
    @Override
    public void preRender(PoseStack poseStack, Mk82Entity entity, BakedGeoModel model, MultiBufferSource bufferSource, VertexConsumer buffer, boolean isReRender, float partialTick, int packedLight, int packedOverlay, float red, float green,
